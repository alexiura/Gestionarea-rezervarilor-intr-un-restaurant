...
<?php require_once "dbConnectMicDejun.php"; ?>
...
<div class="container">
    ...
    $result = $mysqli->query("SELECT * FROM micdejun") or die($mysqli->error);
    //pre_r($result);
        ...
        <table class="table">
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="micDejunForm.php?edit=<?php echo $row['id']; ?>" class="btn btn-info">Edit</a>
                        <a href="micDejunForm.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
            </tbody>
    ...
    <div class="container col-md-4  col-md-offset-4">
        <form action="dbConnectMicDejun.php" class="reserve-form row" method="POST">
